  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative">
        <img
          src="https://images.pexels.com/photos/444658/pexels-photo-444658.jpeg"
          alt="Worship"
          className="w-full h-full object-cover"
        />
        <div className="absolute inset-0 bg-gradient-to-r from-blue-900/80 to-blue-900/60 flex items-center justify-center">
          <div className="text-center text-white p-8">
            ...
            <h1 className="text-4xl font-bold mb-4">G2 Melody</h1>
            <p className="text-xl text-gray-200">Excellence in Worship</p>
          </div>
        </div>
      </div>
