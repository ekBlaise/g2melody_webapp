        ...
        <div className="bg-gray-50 rounded-2xl overflow-hidden">
          ...
          <div className="divide-y divide-gray-100">
            {album.tracks.map((track, index) => (
              <div
                key={track.id}
                className={`grid grid-cols-[auto_1fr_auto_auto] gap-4 px-6 py-4 items-center hover:bg-gray-100 transition-colors group ${playingTrack?.id === track.id ? 'bg-amber-50' : ''
                  }`}
              >
